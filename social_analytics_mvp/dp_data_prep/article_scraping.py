...
@asset(
    ins = {"int__articles__filter_medias": AssetIn(key_prefix=["dp_source_data", "integration"])},
...
def articles_prep(context, int__articles__filter_medias: pd.DataFrame) -> pd.DataFrame:
    # Get partition
